...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/01/14 10:52:28 by fjimenez          #+#    #+#             */
/*   Updated: 2020/02/07 12:17:35 by fjimenez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_hexa_higher_len(t_env *env, size_t len, unsigned int arg,
	char *base)
{
...
static void	ft_hexa_prec(t_env *env, char *base, size_t len,
	unsigned int arg)
{
	if (env->prec < len)
		env->prec = len;
